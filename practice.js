...
function reduce(collection, iteratee, memo, context) { //more concise but too complicated
    var keys = false,
        i = 0,
        currentKey;
...
// (This works because I loaded the underscore library on the left column <-----)
